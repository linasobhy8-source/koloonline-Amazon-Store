...
export default function Home({ products }) {
  ...
  /* ================= FAST FILTER (NO HEAVY SORT EVERY TIME) ================= */
...
export async function getStaticProps() {
  const snap = await getDocs(
    query(collection(db, "products"), limit(30)) // 🔥 تقليل مهم جدًا
  );
  ...
  return {
    props: { products },
    revalidate: 300, // 🔥 بدل 60 → يقلل الضغط
  };
  }
